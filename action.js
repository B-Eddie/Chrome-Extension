document.addEventListener("DOMContentLoaded", function () {
    ...
    chrome.storage.sync.get(y, function (result) {
      ...
      if (z == 0) {
        if (result[y].password != 0) {
          alert(
            "MEETING INFO Copied! You can paste it directly into ZOOM.\n\nIMPORTANT: The meeting password will be copied once you click 'OK'"
          );
          copy(y, 2);
        } else {
          alert(
            "MEETING LINK Copied! Use CRTL/CMD + V to paste the link in your browser."
          );
        }
      } else if (z == 1) {
        alert(
          "The Zoom meeting should open once you press OK.\n\nIMPORTANT: The meeting password is copied and you can paste it into the prompt."
        );
      } else if (z == 2) {
  ...
  chrome.storage.sync.get(null, function (result) {
        ...
        if (key != "current" && key != "version") {
          ...
          if (result.hasOwnProperty(key)) {
            let html =
              '<div id="' +
              result[key].current +
              '"class="input-group" style="width: 95%;margin-left: 2.5%;margin-right: 2.5%;margin-bottom: 10px;">\r\n                   <div class="input-group-prepend"> <span class="input-group-text" style="width: 210px;justify-content: center;white-space:nowrap;display:block;overflow-y: auto;">' +
              result[key].class_name +
              " link" +
              '</span> </div>\r\n                   <div class="input-group-append">\r\n                     <button id="copy' +
              result[key].current +
              '" class="btn btn-primary" type="button" style="border-color: #0096c7;background-color: #0096c7;text-align:center">\r\n                       <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files" fill="currentColor" xmlns="http://www.w3.org/2000/svg">\r\n                         <path fill-rule="evenodd" d="M4 2h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H4z"/>\r\n                         <path d="M6 0h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-1a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1H4a2 2 0 0 1 2-2z"/>\r\n                       </svg>   <button  id="delete' +
              result[key].current +
              '" class="btn btn-primary" type="button" style="border-color: #00b4d8;background-color: #00b4d8;">\r\n                       <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">\r\n                 <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>\r\n                 <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>\r\n                </svg>\r\n                     </button>\r\n                      <button id="aopen' +
              result[key].current +
              '" class="btn btn-primary" type="button" style="border-color: #48cae4;background-color: #48cae4;">\r\n                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-up-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">\r\n <path fill-rule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/>\r\n <path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/>\r\n</svg>\r\n                      </button>\r\n                   </div>\r\n                </div>';
            addElement("area", "div", result[key].current, html);
            let kay = key;
            document
              .getElementById("copy" + kay)
              .addEventListener("click", function (b) {
                copy("" + kay, 0);
                console.log("copy: " + kay);
              });
            document
              .getElementById("delete" + kay)
              .addEventListener("click", function (b) {
                removeElement("" + kay);
              });
            document
              .getElementById("aopen" + kay)
              .addEventListener("click", function (b) {
                open("" + kay);
              });
          }
    ...
    if (versionCheck == false) {
      alert("Whatever you need to say to verify versions");
      ...
      if (zoom_link_val.length || meeting_id_val.length) {
        if (meeting_id_val.length) {
          if (meeting_id_val.length < 10 || meeting_id_val.length > 15) {
            ...
            meeting_link_val =
              "https://zoom.us/j/" + meeting_id_val.replace(/\D/g, "");
            if (password_val) {
        ...
        if (zoom_link_val.length) {
          if (
            zoom_link_val.includes("zoom.us/") ||
            zoom_link_val.includes(".com") ||
            zoom_link_val.includes(".org")
          ) {
      ...
      if (error.length > 0) {
        ...
        chrome.storage.sync.set(
          ...
          function () {
            ...
            document
              .getElementById("copy" + current)
              .addEventListener("click", function (b) {
                copy(current, 0);
              });
            document
              .getElementById("delete" + current)
              .addEventListener("click", function (b) {
                removeElement(current);
              });
            document
              .getElementById("aopen" + current)
              .addEventListener("click", function (b) {
                open("" + current);
              });
          }
